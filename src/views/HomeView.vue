<template>
  <main>
    <!-- Introduction -->
    <section class="mb-8 py-20 text-green-500 text-center relative border-green-500 border-t-2">
      <div
        class="absolute inset-0 w-full h-full bg-contain introduction-bg"
        style="background-image: url(assets/img/wavephone.jpg)"
      ></div>
    ...
    <section class="container mx-auto">
      <div class="bg-white rounded border border-neutral-950 relative flex flex-col">
        <div
          class="px-6 pt-6 pb-5 font-bold border-b border-neutral-950"
